package com.company.thesissandbox.web.invoice;
...
public class InvoiceEdit<T extends TsCard> extends AbstractCardEditor<T> {
    ...
    protected String getHiddenTabsConfig() {
        return "securityTab,cardCommentTab,cardLogTab,processTab";
    }
